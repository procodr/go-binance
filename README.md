...
[![Build Status](https://travis-ci.org/procodr/go-binance.svg?branch=master)](https://travis-ci.org/procodr/go-binance)
[![GoDoc](https://godoc.org/github.com/procodr/go-binance?status.svg)](https://godoc.org/github.com/procodr/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/procodr/go-binance)](https://goreportcard.com/report/github.com/procodr/go-binance)
[![codecov](https://codecov.io/gh/procodr/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/procodr/go-binance)
...
```shell
go get github.com/procodr/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/procodr/go-binance/v1
```
...
```golang
import (
    "github.com/procodr/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/procodr/go-binance) for full references.
...
```go
import (
    "github.com/procodr/go-binance/v2/futures"
)
...
```go
import (
    "github.com/procodr/go-binance/v2/delivery"
)
